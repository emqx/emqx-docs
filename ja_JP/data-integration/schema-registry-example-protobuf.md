...
[デコードシナリオ](#デコードシナリオ)で説明したスキーマと同じものを使用します。
...
以下のコードはPython言語を使い、ユーザーメッセージを作成してバイナリデータにエンコードし、`protobuf_in` トピックに送信します。詳細は[フルコード](https://gist.github.com/thalesmg/c5f03f99f982401d16ef6583e30144fa)を参照してください。
