...
EMQX は http インターフェースを通じて指標を公開することをサポートしています。クラスター全体の統計指標については、ドキュメント [Integrate with Prometheus](../../../../../guides/observability/prometheus.md) をご参照ください。
...
## API シークレットの作成
emqx-exporter と Prometheus は EMQX ダッシュボード API からメトリクスを取得するため、ダッシュボードにサインインして [API キー](../../../../../guides/dashboard/system.md#api-keys) を作成する必要があります。
