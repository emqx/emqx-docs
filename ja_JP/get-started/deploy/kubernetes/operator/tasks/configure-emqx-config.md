...
EMQXは設定ファイル形式として[HOCON](../../../../../guides/configuration/configuration.md#hocon-configuration-format)を使用しています。
...
2. EMQXクラスターが準備完了になるまで待ちます。`kubectl get`コマンドでEMQXクラスターの状態を確認し、`STATUS`が`Ready`になっていることを確認してください。準備完了までに時間がかかる場合があります。
