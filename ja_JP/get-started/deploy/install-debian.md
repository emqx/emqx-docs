...
2. 最新バージョン `@EE_VERSION@` を選択します。**Package Type** のドロップダウンから、DebianのバージョンおよびCPUアーキテクチャに応じた `deb` パッケージを選択します。
3. 下のリンクをクリックしてダウンロードします。ページ上のコマンド手順に従うことも可能です。
...
1. ダウンロードサイトにアクセスし、[**Debianタブ**](https://www.emqx.com/en/downloads-and-install/enterprise?os=Debian)を選択します。
2. 最新バージョン `@EE_VERSION@` を選択します。**Package Type** のドロップダウンから、DebianのバージョンおよびCPUアーキテクチャに応じた `tar.gz` パッケージを選択します。
3. 下のリンクをクリックしてダウンロードします。ページ上のコマンド手順に従うことも可能です。
