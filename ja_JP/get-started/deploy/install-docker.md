...
なお、このセクションのDocker Composeの例はローカルテスト用です。本番環境でクラスターをデプロイする場合は、[クラスター](../../develop/cluster/introduction.md)を参照してください。
...
- 複数ノードによるEMQXクラスターの構築方法については、[クラスター](../../develop/cluster/introduction.md)をご覧ください。
