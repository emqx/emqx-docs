...
| **MQTT over QUIC**               | ✅                                                   | ✅                               | ✅                                 | 世界初のサポート<br>Cloud向けに開発中                        |
...
| **スキーマレジストリ**           | ✅                                                   | ❌                               | ✅                                 | [スキーマレジストリ](../develop/data-integration/schema-registry.md) によるデータ整合性と互換性の保証 |
| **メッセージコーデック**         | ✅                                                   | ❌                               | ✅                                 | JSON、Avro、Protobuf、カスタムコーデック（HTTP/gRPC）に対応した柔軟なメッセージフォーマット変換 |
...
| **エンタープライズデータ統合**   | ✅ 40以上                                            | ✅                               | ✅ 40以上                         | [ビジネス開発とデリバリー速度の加速](https://www.emqx.com/en/integrations) |
...
| **ホットパッチ**                       | ✅                             | N/A                              | N/A                                | 安定したシステム運用の維持                                |
| **オーバーロード保護**                   | ✅                             | N/A                              | N/A                                | システム管理効率の向上                                    |
| **マルチクラスター管理**                 | ✅                             | N/A                              | N/A                                | システムの安定性強化                                      |
| **クラスター指標**                     | ✅                             | N/A                              | N/A                                |                                                              |
...
| **OCSP Stapling**             | ✅                             | ❌                               | ✅                                 | 柔軟なセキュリティ運用の提供                                |
| **フラッピング検出**           | ✅                             | ✅                               | ✅ 製品ロードマップにあり           | 頻繁なオンライン・オフライン接続の検知と遮断                |
...
| **設定**                     | ✅ HOCON                       | N/A                              | N/A                                | HOCON形式はシンプルかつ簡潔です。                            |
| **HTTP API**                 | ✅                             | ✅                               | ✅                                 |                                                              |
| **CLI**                      | ✅                             | ✅                               | ✅                                 |                                                              |
| **設定ホットアップデート**   | ✅                             | N/A                              | N/A                                |                                                              |
| **運用監査**                 | ✅                             | ✅                               | ✅                                 |                                                              |
