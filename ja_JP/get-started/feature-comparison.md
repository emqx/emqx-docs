...
| **実行時の弾力的かつレジリエントなスケーリング** | ✅                            | ❌                              | ✅                                | システムの安定性とリソース利用効率を向上                    |
| **オートスケーリング**               | ✅                            | ✅                              | ✅                                |                                                              |
| **整合性**                         | ✅                            | ✅                              | ✅                                |                                                              |
...
| ---------------------------- | ------------------------------ | ------------------------------ | ---------------------------------- | ------------------------------------------------------------ |
| **TLS/SSL**                  | ✅                              | ✅                              | ✅                                  | データ伝送セキュリティ保護：TLS 1.1、1.2、1.3               |
...
| **Avroバリデーション**        | ✅                              | ❌                              | ✅                                  |                                                              |
| **ProtoBufバリデーション**    | ✅                              | ❌                              | ✅                                  |                                                              |
| **組み込み関数**              | ✅                              | ❌                              | ✅                                  | [SQL文で利用可能な関数、豊富な組み込みライブラリ、カスタム拡張サポート](../develop/data-integration/rule-sql-builtin-functions.md) |
| **jq関数**                   | ✅                              | ❌                              | ✅                                  | 効率的なJSONデータ処理                                     |
...
| **MQTT C用SDK**              | ✅ NanoSDK                      | ✅                              | ✅                                  | [GitHub - nanomq/NanoSDK: QUIC対応NNGフレーバーMQTT 5.0準拠SDK](https://github.com/nanomq/NanoSDK) |
