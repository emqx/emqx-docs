...
| **メッセージキュー**             | ✅                                                  | ❌                              | ✅                                | データ伝送と分析の統合アーキテクチャ                          |
| **ストリーム処理**               | ✅                                                  | ❌                              | ✅                                | 高信頼性と災害復旧機能<br>（近日公開予定）                   |
| **データパーシステンス**         | ✅ RocksDB組み込みバックエンドまたは外部データベース | 該当なし                        | 該当なし                          | [安定性と信頼性の向上](../guides/durability/durability_introduction.md) |
...
| **ファイル転送**                 | ✅                                                  | ❌                              | ✅ 製品ロードマップに記載          | 統合プラットフォームによるデータ伝送                          |
...
| **ダッシュボード / REST API RBAC** | ✅                              | ✅                              | ✅                                | システムセキュリティを確保するための最小権限                   |
...
| **Kubernetes Operator**     | ✅                              | 該当なし                      | 該当なし                        | [EMQX Kubernetes Operator](https://www.emqx.com/en/emqx-kubernetes-operator) |
