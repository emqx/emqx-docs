...
| --interval        | -i     | -            | 10           | クライアント生成間隔（単位：ms）                      |
...
8コア16GBメモリのサーバーを合計3台用意し、1台はEMQX用、残り2台はクライアントプレッシャー用に使用します。
