...
[MQTT.js](https://www.npmjs.com/package/mqtt)は、JavaScriptで実装されたMQTTプロトコルのクライアント機能を持つモジュールであり、ブラウザおよびNode.js環境で利用できます。
...
以下はJavaScriptでMQTT.jsを使い、EMQXに接続してメッセージを送受信する完全なコード例です：
