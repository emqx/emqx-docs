...
属性式は [Variform 式](../../guides/configuration/configuration.md#variform-expressions) と [事前定義関数](../../guides/configuration/configuration.md#pre-defined-functions) を利用して動的に値を処理できます。例：
...
SQL 文、クエリコマンド、HTTP リクエストボディの動的パラメータとして[認証プレースホルダー](../../guides/access-control/authn/authn.md#authentication-placeholders)を利用できます。例：
...
SQL 文、クエリコマンド、トピックで[データクエリプレースホルダー](../../guides/access-control/authz/authz.md#placeholders-in-data-queries)および[トピックプレースホルダー](../../guides/access-control/authz/authz.md#topic-placeholders)を利用できます。
