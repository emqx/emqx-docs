...
詳細な使用方法については、[ESP32 MCPデモ](https://github.com/mqtt-ai/esp32-mcp-mqtt-tutorial/tree/main/samples/blog_3)プロジェクトを参照してください。この例では、ESP-IDFプロジェクトにESP32向けMCP over MQTT C SDKを統合し、MCPサーバーをセットアップし、Python SDKで実装されたMCPクライアントを使用してインタラクションする方法を示しています。
