...
Volcano Engine リアルタイム会話型AIは、インテリジェントエージェントが「聞き、話し、見て、推論する」ことを可能にするエンドツーエンドの音声対話ソリューションです。AIアシスタント、AIカスタマーサービス、AIコンパニオン、AI音声言語学習、インテリジェントハードウェアなどのシナリオに適しています。
...
| 機能                     | 説明                                                         |
| ------------------------ | ------------------------------------------------------------ |
| インテリジェント割り込み | 全二重通信で、ユーザーがいつでもAIの発話を割り込めるため、自然な対話が可能 |
| ビジュアル理解           | 画像や映像入力をサポートし、AIが視覚コンテンツを「見る」ことを可能にする |
| 関数呼び出し             | LLMがユーザーの意図を特定し、外部関数を呼び出せる機能           |
