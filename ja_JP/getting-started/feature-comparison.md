...
| **メッセージキュー**             | ✅                                              | ❌                              | ✅                                  | データ送受信と分析のための統一アーキテクチャ                  |
...
| **OCSP Stapling**             | ✅                              | ❌                              | ✅                                  | 柔軟なセキュリティ運用を提供                                 |
| **フラッピング検出**           | ✅                              | ✅                              | ✅ 製品ロードマップに記載            | 過剰な接続試行の検出とブロック                               |
...
EMQXは進化し続けており、以下に示すものを含む多様なデータ統合をサポートしています。
...
| **Avroバリデーション**       | ✅                              | ❌                              | ✅                                  |                                                              |
| **ProtoBufバリデーション**   | ✅                              | ❌                              | ✅                                  |                                                              |
| **組み込み関数**             | ✅                              | ❌                              | ✅                                  | [SQL文で利用可能な関数群、豊富な組み込みライブラリ、カスタム拡張サポート](../data-integration/rule-sql-builtin-functions.md) |
| **jq関数**                   | ✅                              | ❌                              | ✅                                  | 効率的なJSONデータ処理                                     |
...
| ---------------------------- | ------------------------------ | ------------------------------ | ---------------------------------- | ------------------------------------------------------------ |
| **ダッシュボード**           | ✅                              | ✅                              | ✅                                  | EMQXダッシュボードは機能が充実しています。<br>ダッシュボード経由で設定のホットアップデートが可能です。 |
| **設定**                     | ✅ HOCON                        | N/A                            | N/A                                | HOCON形式はシンプルかつ簡潔です。                            |
| **HTTP API**                 | ✅                              | ✅                              | ✅                                  |                                                              |
| **CLI**                      | ✅                              | ✅                              | ✅                                  |                                                              |
| **設定のホットアップデート** | ✅                              | N/A                            | N/A                                |                                                              |
| **運用監査**                 | ✅                              | ✅                              | ✅                                  |                                                              |
...
| **MQTT CLI**                 | ✅                              | ✅                              | ✅                                  | [MQTTX CLI: 強力かつ使いやすいMQTT CLIツール](https://mqttx.app/cli) |
