...
| **MQTT over QUIC**                | ✅                                                | ✅                              | ✅                                  | 世界初のグローバル対応<br>クラウド向け開発中               |
...
| **Kafka統合**                   | ✅                                                | ✅                              | ✅                                  | [Apache KafkaへのMQTTデータストリーム](../data-integration/data-bridge-kafka.md) |
| **エンタープライズデータ統合**   | ✅ 40以上                                          | ✅                              | ✅ 40以上                          | [ビジネス開発と納期の加速](https://www.emqx.com/en/integrations) |
...
| MQTTと接続性                  | セルフホスト（エンタープライズ） | MQTT as a Service（サーバレス） | MQTT as a Service（専用フレックス） | 備考およびリンク                                            |
| ---------------------------- | ------------------------ | ------------------------------ | ---------------------------------- | ------------------------------------------------------------ |
| **MQTT 3.x**                 | ✅                        | ✅                              | ✅                                  |                                                              |
| **MQTT 5.0**                 | ✅                        | ✅                              | ✅                                  |                                                              |
| **MQTT リテーナー**          | ✅                        | ✅                              | ✅                                  |                                                              |
...
| ----------------------------- | ------------------------ | ------------------------------ | ---------------------------------- | ------------------------------------------------------------ |
| **AWS Marketplace**           | ✅                        | ✅                              | ✅                                  | [AWS Marketplace: EMQXプラットフォーム（従量課金）](https://docs.emqx.com/en/cloud/latest/billing/aws_marketplace.html) |
| **Azure Marketplace**         | ✅                        | ✅                              | ✅                                  | [Azure Marketplace: EMQXプラットフォーム](https://docs.emqx.com/en/cloud/latest/billing/azure_marketplace.html) |
