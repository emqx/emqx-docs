...
| **クラスターリンク**             | ✅                                                | ❌                              | ✅                                  | デバイスおよびアプリケーションデータのシームレス接続        |
| **メッセージキュー**             | ✅                                                | ❌                              | ✅                                  | データ伝送と分析のための統一アーキテクチャ                  |
| **ストリーム処理**               | ✅                                                | ❌                              | ✅                                  | 高い信頼性と災害復旧機能<br>（近日公開予定）                |
...
| **信頼性**                       | 高可用レプリケーションを備えたRocksDBによるデータパーシステンス | セッションパーシステンス        | セッションパーシステンス           | [RocksDBに基づく高信頼MQTTデータパーシステンス](https://www.emqx.com/en/blog/mqtt-persistence-based-on-rocksdb) |
...
| **ノード退避＆クラスター再バランス** | ✅                        | 該当なし                       | 該当なし                         | ノンストップクラスター保守                                  |
...
| **ダッシュボード / REST API RBAC** | ✅                        | ✅                              | ✅                                  | 最小権限でシステムの安全性を確保                            |
...
| **MQTT 5.0 拡張認証**          | ✅                        | 該当なし                       | 該当なし                         | [MQTT 5.0 拡張認証](../access-control/authn/scram.md)         |
| **LDAP認証**                  | ✅                        | ❌                              | ✅ 製品ロードマップにあり           |                                                              |
...
| **MQTT C向けSDK**            | ✅ NanoSDK                | ✅                              | ✅                                  | [GitHub - nanomq/NanoSDK: QUIC対応NNGフレーバーMQTT 5.0準拠SDK](https://github.com/nanomq/NanoSDK) |
