...
| **MQTT 5.0 強化認証**           | ✅                            | N/A                            | N/A                              | [MQTT 5.0 強化認証](../access-control/authn/scram.md)        |
| **LDAP認証**                   | ✅                            | ❌                            | ✅ 製品ロードマップに記載           |                                                              |
...
| **Avroバリデーション**      | ✅                            | ❌                            | ✅                                |                                                              |
| **ProtoBufバリデーション**  | ✅                            | ❌                            | ✅                                |                                                              |
| **組み込み関数**            | ✅                            | ❌                            | ✅                                | [SQL文で利用可能な関数群、豊富な組み込みライブラリ、カスタム拡張対応](../data-integration/rule-sql-builtin-functions.md) |
| **jq関数**                  | ✅                            | ❌                            | ✅                                | 効率的なJSONデータ処理                                     |
