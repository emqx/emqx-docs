...
| **データパーシステンス**         | ✅ RocksDB組み込みバックエンドまたは外部データベース  | 該当なし                        | 該当なし                          | [安定性と信頼性の向上](../durability/durability_introduction.md) |
...
| **Kafka統合**                   | ✅                                                    | ✅                              | ✅                                | [MQTTデータをApache Kafkaにストリーム](../data-integration/data-bridge-kafka.md) |
...
| **ネットワーク分断からの復旧**         | ✅                              | ✅                              | ✅                                | クラスター障害の自動修復                                    |
| **ノード退避とクラスターリバランス**   | ✅                              | 該当なし                      | 該当なし                        | ノンストップのクラスター保守                                |
...
| オブザーバビリティ           | セルフホスト（エンタープライズ） | MQTT as a Service（サーバーレス） | MQTT as a Service（専用フレックス） | 備考およびリンク                                         |
| ---------------------------- | -------------------------------- | -------------------------------- | ---------------------------------- | ------------------------------------------------------- |
...
| **MQTT C SDK**               | ✅ NanoSDK                      | ✅                              | ✅                                | [GitHub - nanomq/NanoSDK: QUIC対応NNG風MQTT 5.0準拠SDK](https://github.com/nanomq/NanoSDK) |
