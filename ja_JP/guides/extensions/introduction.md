...
EMQX のプラグイン開発インターフェースを通じて、ユーザーはコアプロセスにアクセスし、アクセス制御、メッセージルーティング、メッセージ保存などのビジネスロジックをカスタマイズできます。さらに、プロトコル拡張により、統一された[ゲートウェイ](../../develop/gateway/gateway.md)フレームワークを通じてクライアントのアクセス管理が可能です。
