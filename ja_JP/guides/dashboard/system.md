...
API キーのページでは、以下の手順で [HTTP API](../../guides/api.md) へのアクセス用に API キーとシークレットキーを生成できます。
...
2. 作成ダイアログで API キーの詳細情報を設定します。
   ...
   - API キーのロールを選択できます（任意）。ロールの詳細は [Roles and Permissions](../../guides/api.md#roles-and-permissions) を参照してください。
