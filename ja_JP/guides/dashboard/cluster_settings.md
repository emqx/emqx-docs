...
レート制限の詳細な設定については[レート制限](../rate-limit.md)を参照してください。
...
クラスターリンク機能は、複数の独立したEMQXクラスターを接続し、地理的に分散したクラスター間でクライアント同士の通信を可能にします。このページでクラスターリンクの作成および設定ができます。作成と設定の詳細は[EMQXクラスターリンク](../../develop/cluster-linking/introduction.md)を参照してください。
