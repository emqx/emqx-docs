...
組み込みデータベースに保存されている認証データについては、EMQX ダッシュボードまたは HTTP API を使用して、ユーザー認証情報の作成、更新、削除、一覧表示、およびインポートが可能です。
...
識別子の命名規則やパラメーターの説明については、[REST API](../../../guides/api.md) をご参照ください。
