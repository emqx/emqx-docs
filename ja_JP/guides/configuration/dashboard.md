...
- `swagger_support = true`
  ...
  EMQX 6.3.0以降、これらのエンドポイントを通じたAPI仕様コンテンツへのアクセスには認証が必要です。対応する認証方法や未認証時の応答動作については[Access API Specification Endpoints](../api.md#access-api-specification-endpoints)を参照してください。
