...
さらに、設定ファイルでライセンス接続クォータ使用率の設定を以下のように行うことができます。
...
EMQXダッシュボードからもライセンスファイルを設定できます。ダッシュボードでのライセンス設定方法については、[Work with License](../../get-started/deploy/license.md) を参照してください。ダッシュボードで設定した内容は設定ファイルの同じ項目より優先されます。
