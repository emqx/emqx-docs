...
標準のMCP機能をすべて保持しつつ、MCP over MQTTは以下の特徴で機能を強化・拡張しています。
...
- **サービス名管理および配布**  
  標準MCPプロトコルに加え、EMQXはサービス識別と分類のための**MCPサービス名**の概念を導入しています。管理者はEMQX上でサービス名を集中管理・配布でき、複数サービス環境での統一的な管理と保守を簡素化します。
