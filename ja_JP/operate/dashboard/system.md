...
API キーのページでは、以下の手順で [HTTP API](../admin/api.md) へのアクセス用に API キーとシークレットキーを生成できます。
...
2. 作成ダイアログで API キーの詳細情報を設定します。
   ...
   - API キーのロールを選択できます（任意）。ロールの詳細は [Roles and Permissions](../admin/api.md#roles-and-permissions) を参照してください。
...
**ライセンス更新** をクリックしてライセンスキーをアップロードします。**ライセンス設定** セクションでは、ライセンス接続クォータの使用に対する高水位および低水位の制限を設定できます。ライセンスの詳細については、[EMQX Enterprise ライセンスの利用](../deploy/license.md) を参照してください。
