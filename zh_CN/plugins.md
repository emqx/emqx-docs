...
| [ emq_auth_pgsql ](https://github.com/emqtt/emq_auth_pgsql)           | PostgreSQ L 认证/访问控制 |
| [ emq_auth_redis ](https://github.com/emqtt/emq_auth_redis)           | Redis 认证/访问控制       |
| [ emq_web_hook ](https://github.com/emqtt/emq-web-hook)               | Web Hook 插件             |
| [ emq_lua_hook ](https://github.com/emqtt/emq-lua-hook)               | Lua Hook 插件             |
| [ emq_auth_mongo ](https://github.com/emqtt/emq_auth_mongo)           | MongoDB 认证/访问控制     |
| [ emq_modules ](https://github.com/emqtt/emq-modules)                 | 扩展模块插件              |
| [ emq_retainer ](https://github.com/emqtt/emq-retainer)               | Retain 消息存储模块       |
...
| [ emq_sockjs ](https://github.com/emqtt/emq_sockjs)                   | Stomp/SockJS 协议支持     |
...
EMQ 2.0-rc.2 版本将 ClientId 认证模块改为独立插件: [ https://github.com/emqtt/emq_auth_clientid ](https://github.com/emqtt/emq_auth_clientid)
...
EMQ 2.0-rc.2 版本将用户名认证模块改为独立插件: [ https://github.com/emqtt/emq_auth_username ](https://github.com/emqtt/emq_auth_username)
...
EMQ 消息服务器的 Web 管理控制台。插件项目地址: [ https://github.com/emqtt/emqttd_dashboard ](https://github.com/emqtt/emqttd_dashboard)

EMQ 消息服务器默认加载 Dashboard 插件。URL 地址: [ http://localhost:18083 ](http://localhost:18083) ，缺省用户名/密码: admin/public。
...
LDAP 认证插件: [ https://github.com/emqtt/emq_auth_ldap ](https://github.com/emqtt/emq_auth_ldap)
...
HTTP 认证/访问控制插件: [ https://github.com/emqtt/emq_auth_http ](https://github.com/emqtt/emq_auth_http)
...
MySQL 认证/访问控制插件，基于 MySQL 库表认证鉴权: [ https://github.com/emqtt/emq-auth-mysql ](https://github.com/emqtt/emq-auth-mysql)
...
Postgre 认证/访问控制插件，基于 PostgreSQL 库表认证鉴权: [ https://github.com/emqtt/emqttd_plugin_pgsql ](https://github.com/emqtt/emqttd_plugin_pgsql)
...
基于 Redis 认证/访问控制: [ https://github.com/emqtt/emqttd_plugin_redis ](https://github.com/emqtt/emqttd_plugin_redis)
...
::: warning
2.0-rc.2 版本已将订阅加载迁移至 EMQX 产品的 emqx_backend_redis 插件。
:::
...
基于 MongoDB 认证/访问控制: [ https://github.com/emqtt/emqttd_plugin_mongo ](https://github.com/emqtt/emqttd_plugin_mongo)
...
参考 [ emq_plugin_template ](https://github.com/emqtt/emq_plugin_template) 插件模版创建新的插件项目。
