...
| **消息验证**           | ✅                                 | ❌                   | ✅               | 确保消息的完整性和合法性                                     |
| **规则引擎**           | ✅                                 | ✅                   | ✅               | [基于 SQL 的内置规则引擎](https://docs.emqx.com/zh/emqx/latest/data-integration/rules.html) |
| **Flow 设计器**        | ✅                                 | ❌                   | ✅               | [更简便的数据集成编排](https://docs.emqx.com/zh/emqx/latest/flow-designer/introduction.html) |
| **文件传输**           | ✅                                 | ❌                   | ✅ 已规划        | 统一平台数据传输                                             |
| **Kafka 集成**         | ✅                                 | ✅                   | ✅               | [将 MQTT 数据传输到 Apache Kafka](https://docs.emqx.com/zh/emqx/latest/data-integration/data-bridge-kafka.html) |
| **企业级数据集成**     | ✅ 40+                             | ✅                   | ✅ 40+           | [提升业务开发和发布速度](https://www.emqx.com/zh/integrations) |
| **故障排查**           | ✅                                 | ❌                   | ✅               | [日志追踪 (Trace)](https://docs.emqx.com/zh/emqx/latest/observability/tracer.html)<br>[慢订阅统计](https://docs.emqx.com/zh/emqx/latest/observability/slow-subscribers-statistics.html) |
...
| **审计日志**                                     | ✅               | ✅                   | ✅               | 支持重要操作的审计追踪                                       |
| **Dashboard 单点登录（SSO）**                    | ✅               | ✅                   | ✅               | [安全简便的认证流程](https://docs.emqx.com/zh/emqx/latest/dashboard/sso.html) |
...
| --------------------- | --------------- | ----------------------- | --------------- | ------------------------------------------------------------ |
| **用户名/密码**       | ✅               | ✅                       | ✅               | [密码认证](https://docs.emqx.com/zh/emqx/latest/access-control/authn/pwoverview.html) |
| **JWT**               | ✅               | ❌                       | ✅               | [JWT 认证](https://docs.emqx.com/zh/emqx/latest/access-control/authn/jwt.html) |
| **MQTT 5.0 增强认证** | ✅               | N/A                     | N/A             | [MQTT 5.0 增强认证](https://docs.emqx.com/zh/emqx/latest/access-control/authn/scram.html) |
| **LDAP**              | ✅               | ❌                       | ✅ 已规划        |                                                              |
| **PSK 验证**          | ✅               | ❌                       | ✅               | [启用 PSK 认证](https://docs.emqx.com/zh/emqx/latest/network/psk-authentication.html#enable-psk-authentication) |
...
| **Avro 消息验证**     | ✅               | ❌                   | ✅               |                                                              |
| **ProtoBuf 消息验证** | ✅               | ❌                   | ✅               |                                                              |
| **内置 SQL 函数**     | ✅               | ❌                   | ✅               | [丰富的内置 SQL 函数，支持自定义扩展](https://docs.emqx.com/zh/emqx/latest/data-integration/rule-sql-builtin-functions.html) |
| **jq 函数**           | ✅               | ❌                   | ✅               | 高效的 JSON 数据处理                                         |
| **客户端事件处理**    | ✅               | ❌                   | ✅               | [客户端事件](https://docs.emqx.com/zh/emqx/latest/data-integration/rule-sql-events-and-fields.html#客户端事件)，事件驱动的业务开发 |
| **Schema 验证**       | ✅               | ❌                   | ✅               |                                                              |
| **消息转换**          | ✅               | ❌                   | ✅               |                                                              |
...
| ---------------- | --------------- | ------------------- | --------------- | ------------------------------------------------------------ |
| **钩子**         | ✅               | N/A                 | N/A             | [钩子](https://docs.emqx.com/zh/emqx/latest/extensions/hooks.html) |
| **插件**         | ✅               | N/A                 | N/A             | [插件](https://docs.emqx.com/zh/emqx/latest/extensions/plugins.html) |
| **插件热加载**   | ✅               | N/A                 | N/A             |                                                              |
| **插件热配置**   | ✅               | N/A                 | N/A             |                                                              |
| **网关**         | ✅               | N/A                 | N/A             |                                                              |
