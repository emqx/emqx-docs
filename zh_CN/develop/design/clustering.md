...
有关创建和运行 EMQX 5.0 集群的详细说明，请参阅 [分布式集群介绍](../cluster/introduction.md)。
...
为了解决这个问题，EMQX Enterprise（从版本 4.4 开始）引入了一个新功能，称为“[集群负载重平衡](../../operate/cluster/rebalancing.md)”。该功能允许集群通过将会话从过载节点迁移到负载较轻的节点来自动重新平衡负载。
