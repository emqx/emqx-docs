...
::: tip
从 EMQX 6.3.0 开始，规则、连接器、动作、Source 和数据桥接由 `data_integration` 功能门控控制。如果手动设置 `EMQX_FEATURES`，启用 `data_integration` 时也会自动启用其依赖的 `schema_registry`。更多信息请参见[功能门控](../../get-started/deploy/feature-gates.md)。
:::
...
![image](./assets/rules/rules/cn_introduction_flow.png)
