...
[MQTT.js](https://github.com/mqttjs/MQTT.js) 是 JavaScript 编写的，实现了 MQTT 协议客户端功能的模块，可以在浏览器 和 Node.js 环境中使用。

由于 JavaScript 单线程特性，MQTT.js 是全异步 MQTT 客户端，MQTT.js 支持 MQTT 与 [MQTT over WebSocket](./mqtt-over-websocket.md)，在不同运行环境支持的度如下：
