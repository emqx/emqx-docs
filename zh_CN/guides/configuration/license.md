...
您可以通过配置文件 `emqx.conf` 更新您的 License 文件并配置 License 连接配额使用的设置。配置完成后，您可以在 [EMQX 命令行工具](../cli.md) 中运行 `emqx ctl license reload` 来重新加载 License。
...
您也可以通过 EMQX Dashboard 或关于如何通过 Dashboard 配置 License，请参见[配置 License](../../get-started/deploy/license.md)。
