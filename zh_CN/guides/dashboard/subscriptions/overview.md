...
顶部搜索栏默认显示节点、客户端 ID 和 Topic 3 个过滤搜索字段。其中节点为下拉选择框，可以选择查看连接到某个节点的客户端订阅，或使用客户端 ID 和 Topic 对订阅列表进行模糊搜索。点击搜索栏右侧箭头按钮还将显示 QoS 和共享名称过滤输入框，[共享名称](../../../get-started/messaging/mqtt-shared-subscription.md)支持的是精确匹配。
