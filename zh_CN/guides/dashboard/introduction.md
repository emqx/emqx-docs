...
::: tip
从 EMQX 6.3.0 开始，部署时可以使用[功能门控](../../get-started/deploy/feature-gates.md)在启动阶段禁用可选功能。功能被禁用后，Dashboard 会隐藏对应的菜单和页面。
:::
...
有关认证方式、URL Token 登录、密码管理、账户锁定、HTTPS 和基于角色的访问控制，参见 [Dashboard 安全](../dashboard-security.md)。
