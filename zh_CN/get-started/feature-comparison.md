...
| **消息验证**           | ✅                                 | ❌                   | ✅               | 确保消息的完整性和合法性                                     |
| **规则引擎**           | ✅                                 | ✅                   | ✅               | [基于 SQL 的内置规则引擎](../develop/data-integration/rules.md)      |
| **Flow 设计器**        | ✅                                 | ❌                   | ✅               | [更简便的数据集成编排](../develop/flow-designer/introduction.md)     |
| **文件传输**           | ✅                                 | ❌                   | ✅ 已规划        | 统一平台数据传输                                             |
...
| **故障排查**           | ✅                                 | ❌                   | ✅               | [日志追踪 (Trace)](../guides/observability/tracer.md)<br>[慢订阅统计](../guides/observability/slow-subscribers-statistics.md) |
...
| **连接抖动**                                     | ✅               | ✅                   | ✅ 规划中        | 检测并拦截短时间内过多的连接尝试                             |
| **审计日志**                                     | ✅               | ✅                   | ✅               | 支持重要操作的审计追踪                                       |
| **Dashboard 单点登录（SSO）**                    | ✅               | ✅                   | ✅               | [安全简便的认证流程](../guides/dashboard/sso.md) |
...
| **Avro 消息验证**     | ✅               | ❌                   | ✅               |                                                              |
| **ProtoBuf 消息验证** | ✅               | ❌                   | ✅               |                                                              |
| **内置 SQL 函数**     | ✅               | ❌                   | ✅               | [丰富的内置 SQL 函数，支持自定义扩展](../develop/data-integration/rule-sql-builtin-functions.md) |
| **jq 函数**           | ✅               | ❌                   | ✅               | 高效的 JSON 数据处理                                         |
| **客户端事件处理**    | ✅               | ❌                   | ✅               | [客户端事件](../develop/data-integration/rule-sql-events-and-fields.md#客户端事件)，事件驱动的业务开发 |
| **Schema 验证**       | ✅               | ❌                   | ✅               |                                                              |
| **消息转换**          | ✅               | ❌                   | ✅               |                                                              |
