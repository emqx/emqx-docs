...
参照[通过 Dashboard 安装插件](../../guides/extensions/plugin-management.md#通过-dashboard-安装插件)的说明，通过 Dashboard 安装插件。插件包发布地址为 `https://packages.emqx.io/emqx-plugins/e<EMQX-VSN>/`。
