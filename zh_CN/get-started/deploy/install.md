...
| [macOS](./install-macOS.md)       | macOS 14<br />macOS 15<br />macOS 26             | 否 | 是 |
...
3. `data`、`log`、`plugins` 目录可以通过配置文件设置，建议将 `data` 目录挂载至高性能磁盘以获得更好的性能。但对于属于同一集群的节点， `data` 目录的配置应该相同。更多关于集群的介绍，见[集群章节](../../guides/cluster/create-cluster.md)。
   :::
