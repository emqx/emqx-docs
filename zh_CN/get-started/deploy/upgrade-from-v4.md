...
要了解我们在 EMQX 5.0 和 5.1中增加的新功能，请查看 [全新功能](../new-features.md)。
...
详细的格式请参照[日志 - 日志格式](../../guides/observability/log.md#日志格式)。
...
- [认证占位符](../../guides/access-control/authn/authn.md#认证占位符)
- [授权占位符](../../guides/access-control/authz/authz.md#占位符)
...
2. 需要从 MongoDB 中查询出包含 `action` `permission` `topics` 字段的数据列表，使用方式详见 [AuthZ-MongoDB](../../guides/access-control/authz/mongodb.md)。
...
如果您想要使用 push-gateway，可参考[集成 Prometheus](../../guides/observability/prometheus.md)。
