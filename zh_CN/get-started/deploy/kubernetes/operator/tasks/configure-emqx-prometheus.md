...
1. EMQX 通过 [Prometheus 兼容的 HTTP API](../../../../../guides/observability/prometheus.md) 暴露各种指标。
...
Prometheus 将从 EMQX Dashboard API 拉取指标，因此您需要登录 Dashboard [创建 API Secret](../../../../../guides/dashboard/system.md#api-密钥)。
