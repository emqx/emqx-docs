...
- [#11532](https://github.com/emqx/emqx/pull/11532) 改进了对解析无效数据包时的错误消息，以提供更清晰的错误提示。

### 修复

- [#11493](https://github.com/emqx/emqx/pull/11493) 修复了关于 `/api/v5/publish` 的示例和文档中有关错误请求响应的问题。之前的文档示例指出错误请求的响应可以在响应体中返回一个列表，但实际情况并非如此。
