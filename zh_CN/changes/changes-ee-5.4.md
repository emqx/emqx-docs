...
- [#12129](https://github.com/emqx/emqx/pull/12129) 默认许可证续订。替换了 2023 年 1 月发布的旧许可证。新许可证支持最多 25 个并发连接。
...
- [#12081](https://github.com/emqx/emqx/pull/12081) 更新了 `gen_rpc` 库到版本 3.3.0。这个新版本包括了一些性能改进：
