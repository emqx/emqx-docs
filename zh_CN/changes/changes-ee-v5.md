...
- [#12236](https://github.com/emqx/emqx/pull/12236) 修复了 MQTT Sink/Source 客户端 ID 生成方法，以符合 MQTT 3.1 规范的 23 字节限制。 客户端 ID 现在以用户分配的数据集成名称为前缀，后跟节点名称的 SHA 哈希值和池成员 ID 的前 8 个字节。 如果生成的 ID 超过 23 字节，则会应用额外的 SHA 哈希和截断以确保合规性。
