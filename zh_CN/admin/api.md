...
EMQX 的 REST API 使用 [Basic 认证](https://en.wikipedia.org/wiki/Basic_access_authentication) 携带认证凭据，您可以在 Dashboard “系统设置” -> “API 密钥” 界面中创建 API 密钥用于认证，也可以通过如下的 API 调用来创建一个新的 API 密钥。
