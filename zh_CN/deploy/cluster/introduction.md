...
相比与之前版本，EMQX 5.0 集群采用了新的 [Mria 集群架构](./mria-introduction.md)，采用核心-复制（Core-Replicant）设计，大幅提升了 EMQX 的水平扩展能力，使其单节点能支持 500 万 MQTT 设备连接，集群可扩展至 1 亿并发 MQTT 连接。

::: tip 提示

EMQX 开源版的集群规模不超过 3 个节点，因此仍将保留基础的无主（Masterless）集群架构，以满足用户对可靠性和可扩展性的需求。
