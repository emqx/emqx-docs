...
![EMQX Apache Doris 数据集成](/Users/emqx/Documents/GitHub/emqx-docs/zh_CN/data-integration/assets/emqx-integraion-mysql.jpg)
...
- **灵活数据操作**：通过 Apache Doris Sink 提供的 SQL 模板，可以方便地将特定字段的数据写入或更新到 Apache Doris 数据库的对应表和列中，实现数据的灵活存储和管理。
- **整合业务流程**：通过 Apache Doris Sink 可以将设备数据与 Apache Doris 丰富的生态应用结合，方便的与例如 ERP 与 CRM 或其他自定义业务系统进行集成，以实现更高级的业务流程和自动化操作。
