...
project = u'EMQ - 百万级分布式开源MQTT消息服务器'
...
latex_documents = [
  ('index', 'EMQ.tex', u'EMQ 2.0 Documentation',
...
texinfo_documents = [
  ('index', 'EMQ', u'EMQ Documentation',
   u'李枫 <feng@emqtt.io>', 'EMQ', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_copyright = u'2016, Feng Lee <feng@emqtt.io>'
