...
EMQX 4.0.13 is released now, it mainly includes the following changes:
...
EMQX 4.0.11 is released now, it mainly includes the following changes:
...
EMQX 4.0.9 is released now, it fixes a bug in MQTT message parser.

## 4.0.7

*Release Date: 2020-05-09*

EMQX 4.0.7 is released now, it mainly includes the following changes:
