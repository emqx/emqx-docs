...
- [Subscription Filters](../../develop/subscription-filter/subscription-filter-concept.md)
- [Message Queue](../../develop/message-queue/message-queue-concept.md)

### Subscription Filters (Advanced)

[Subscription Filters](../../develop/subscription-filter/subscription-filter-concept.md) is an advanced feature introduced in EMQX 6.2 that extends the MQTT 5.0 pub/sub model with content-based filtering at the subscription level. By appending a filter expression to a topic filter, subscribers can instruct EMQX to deliver only messages whose MQTT 5.0 User Properties satisfy the specified conditions.
...
[Message Queue](../../develop/message-queue/message-queue-concept.md) is an advanced feature introduced in EMQX 6.0 that extends the MQTT pub/sub model with durable and asynchronous message queuing capabilities. It allows messages to be stored even when subscribers are offline and supports advanced dispatch strategies and message compaction through Last-Value Semantics.
