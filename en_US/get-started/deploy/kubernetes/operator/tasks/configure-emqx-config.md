...
EMQX uses [HOCON](../../../../../guides/configuration/configuration.md#hocon-configuration-format) as the configuration file format.
...
1. Save the following as a YAML file and deploy it using `kubectl apply`:
   ...
   ::: tip
   The content of the `.spec.config.data` field is supplied as [`emqx.conf` configuration file](../../../../../guides/configuration/configuration.md#immutable-configuration-file) to the EMQX container.
   :::
