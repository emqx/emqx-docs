...
For EMQX cluster load rebalancing, please refer to the document: [Rebalancing](../../../../../guides/cluster/rebalancing.md)
...
For user-triggered load rebalancing, use the EMQX rebalancing tools directly. For details, refer to [Rebalancing](../../../../../guides/cluster/rebalancing.md).
