...
| **Data Persistence**             | ✅ Built-in RocksDB backend or external databases | N/A                            | N/A                                | [Improved stability and reliability](../operate/durability/durability_introduction.md) |
...
| **Rule Engine**                  | ✅                                                | ✅                              | ✅                                  | [SQL-based built-in Rule Engine and real-time data processing](../develop/data-integration/rules.md) |
| **Flow Designer**                | ✅                                                | ❌                              | ✅                                  | [Easy orchestration of data integration](../develop/flow-designer/introduction.md) |
...
| **Avro Validation**        | ✅                        | ❌                              | ✅                                  |                                                              |
| **ProtoBuf Validation**    | ✅                        | ❌                              | ✅                                  |                                                              |
| **Built-in Functions**     | ✅                        | ❌                              | ✅                                  | [Functions available in SQL statements, rich built-in libraries, support custom extensions](../develop/data-integration/rule-sql-builtin-functions.md) |
| **jq Functions**           | ✅                        | ❌                              | ✅                                  | Efficient JSON data processing                               |
| **Event Trigger**          | ✅                        | ❌                              | ✅                                  | [Client events](../develop/data-integration/rule-sql-events-and-fields.md#mqtt-events), event-driven business development |
| **Schema Validation**      | ✅                        | ❌                              | ✅                                  |                                                              |
