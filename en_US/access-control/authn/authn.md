...
- `${client_attrs.NAME}`: It will be replaced by the custom attribute names extracted from the client metadata at runtime. For details about the attribute extraction, see [MQTT Client Attribute Extraction](../../client-attributes/client-attributes.md).
