...
| **MQTT Add-ons**                 | ✅                                                | ❌                              | ✅                                  | [Shared subscription](https://docs.emqx.com/en/emqx/latest/messaging/mqtt-shared-subscription.html)<br>[Exclusive subscription](https://docs.emqx.com/en/emqx/latest/messaging/mqtt-exclusive-subscription.html)<br>[Delayed publish](https://docs.emqx.com/en/emqx/latest/messaging/mqtt-delayed-publish.html)<br>[Auto-subscription](https://docs.emqx.com/en/emqx/latest/messaging/mqtt-auto-subscription.html)<br>[Topic rewrite](https://docs.emqx.com/en/emqx/latest/messaging/mqtt-topic-rewrite.html)<br>More customization options |
