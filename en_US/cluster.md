...
| -------------------- | ------------------- | ---------------------------- |
| emqttd@s1.emqx.io or | emqttd@192.168.0.10 | s1.emqx.io 192.168.0.10:1883 |
| emqttd@s2.emqx.io or | emqttd@192.168.0.20 | s2.emqx.io 192.168.0.20:1883 |

::: warning Warning
he node name is Name@Host , where Host is IP address or the fully qualified host name.
:::
