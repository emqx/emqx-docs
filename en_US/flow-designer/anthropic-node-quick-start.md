...
3. Review results and node processing metrics.
   ...
   - To view the running statistics and metrics of the **Anthropic** node, exit the editting page, click the node to open the Edit panel and click the **Overview** tab.
