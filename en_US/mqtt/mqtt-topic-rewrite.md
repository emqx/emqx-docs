...
You can combine the [retained message](./retained.md) and [delayed publish](./mqtt-delayed-publish.md) feature with this topic rewriting. For example, when users want to use the delayed publish, they can use topic rewrite to redirect the message to the required topic.
