...
8. Configure the **SQL Template** based on the feature to use:
   ...
   Starting from EMQX 6.3.1, when batch mode is enabled, EMQX uses a restricted SQL parser when creating the Sink, renders the template safely, and rejects unsupported syntax.
