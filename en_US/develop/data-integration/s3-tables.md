...
5. Provide the required connection details:
   ...
   - **Enable TLS**: TLS is enabled by default when connecting to S3 Tables. For detailed TLS connection options, see [TLS for External Resource Access](../../guides/network/overview.md#enable-tls-encryption-for-accessing-external-resources).
