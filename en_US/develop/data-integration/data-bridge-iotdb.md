...
4. Configure the connector:
   ...
   - **Enable TLS**: Enable this option to establish an encrypted connection to the Apache IoTDB server. For more information, see [TLS for External Resource Access](../../guides/network/overview.md#tls-for-external-resource-access).
