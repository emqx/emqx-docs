...
4. In the **Configuration** step, configure the following information:
   ...
   - Set whether to enable TLS. For detailed information about TLS connection options, refer to [Enable TLS Encryption to Access External Resources](../../guides/network/overview.md#tls-for-external-resource-access).
