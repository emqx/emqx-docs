...
1. Open MQTTX client desktop and connect to the EMQX broker. For detailed information on working with the MQTTX, refer to [MQTTX Client](../../get-started/messaging/publish-and-subscribe.md).
