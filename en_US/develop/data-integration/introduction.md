...
::: tip
Starting from EMQX 6.3.0, rules, connectors, actions, sources, and data bridges are controlled by the `data_integration` feature gate. If you set `EMQX_FEATURES` manually, enabling `data_integration` also enables its required `schema_registry` dependency. For more information, see [Feature Gates](../../get-started/deploy/feature-gates.md).
:::
