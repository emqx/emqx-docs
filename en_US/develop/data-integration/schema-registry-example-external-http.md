...
| **Enable TLS** | No     | Toggle on if your external HTTP server requires a TLS connection. For details, see [TLS for External Resource Access](../../guides/network/overview.md#tls-for-external-resource-access). |
