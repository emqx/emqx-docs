...
4. In the **Configuration** step, configure the following information:
   ...
   - **RocketMQ Namespace**: Enter the namespace configured for the RocketMQ service. For Alibaba Cloud RocketMQ, enter the instance ID. Leave this field empty if the RocketMQ service does not use a namespace.
