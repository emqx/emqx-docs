...
- [Message Queue](./message-queue/message-queue-concept.md) extends MQTT publish/subscribe with durable queue semantics for reliable, asynchronous message delivery.
- [MQTT over WebSocket](./connect-emqx/mqtt-over-websocket.md) enables MQTT clients, including browser-based applications, to connect to EMQX over WebSocket.
