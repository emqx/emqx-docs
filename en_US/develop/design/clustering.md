...
For detailed instructions on creating and running an EMQX 5.0 cluster, refer to [EMQX Cluster](../cluster/introduction.md).
...
To address this issue, EMQX Enterprise (since version 4.4) introduced a new feature called "[Cluster Load Rebalancing](../../operate/cluster/rebalancing.md)". This feature allows the cluster to automatically rebalance the load by migrating the sessions from the overloaded nodes to the underloaded nodes.
