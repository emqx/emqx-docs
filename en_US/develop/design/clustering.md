...
To address this issue, EMQX Enterprise (since version 4.4) introduced a new feature called "[Cluster Load Rebalancing](../../guides/cluster/rebalancing.md)". This feature allows the cluster to automatically rebalance the load by migrating the sessions from the overloaded nodes to the underloaded nodes.
