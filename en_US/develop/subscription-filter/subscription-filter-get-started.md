...
Restart EMQX for the change to take effect, or reload the configuration if your deployment supports it.
...
Publish a message with no User Properties:
...
- [Wildcard Subscription](../../get-started/messaging/mqtt-wildcard-subscription.md): Combine wildcard topic filters with Subscription Filters for flexible routing.
