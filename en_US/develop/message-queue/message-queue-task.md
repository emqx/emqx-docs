...
The Queue Key Expression specifies how to extract the key used for message deduplication in Last-Value Semantics mode. This expression is evaluated against a message's metadata and follows the syntax of [Variform expressions](../../guides/configuration/configuration.md#variform-expressions).
