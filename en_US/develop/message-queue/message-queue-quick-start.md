...
The "Queue Key Expression" defines how EMQX extracts a key from each message for deduplication in Last-Value Queues. This field supports configuration using [Variform expressions](../../guides/configuration/configuration.md#variform-expressions).
