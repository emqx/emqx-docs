...
- **Message Queue Message DB**
  Stores the actual messages published to queues and is built on EMQX’s [Durable Storage](../../guides/durability/durability_introduction.md#durable-storage-architecture).
