...
- **Client Attributes**: Optionally, you can specify [client attributes](../../../develop/client-attributes/client-attributes.md) using the `client_attrs` field. Both keys and values must be strings.
