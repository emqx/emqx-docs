...
- **Enable QoS 3**: QoS 3 is Also known as QoS -1. This setting is intended for basic clients that only need to send `PUBLISH` messages to the gateway; default: `true`, optional values: `true`, `false`.
