...
| ------------------------------------------------------------ | ------------------------------------- | ---------------------------------- |
| [emqx_dashboard](https://github.com/emqx/emqx-dashboard)   | etc/plugins/emqx_dashboard.conf       | Web dashboard Plugin (Default)     |
...
| [emqx_auth_mnesia](https://github.com/emqx/emqx-auth-mnesia) | etc/plugins/emqx_auth_mnesia.conf     | Mnesia Auth/access control         |
