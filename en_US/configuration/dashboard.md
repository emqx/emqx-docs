...
- `swagger_support  =  true`  is to enable all swagger related futures like the swagger API documentation. By default, its value is always `true`, you can set the value to `false` to disable it.
