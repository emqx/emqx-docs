...
-Methods prefixed with ʻOnClient*`, ʻOnSession*`, ʻOnMessage*` correspond to the methods in [hooks](hooks.md) one-to-one. They have the same calling timing and similar parameter lists.
