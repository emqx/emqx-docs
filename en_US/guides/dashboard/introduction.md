...
::: tip
Starting from EMQX 6.3.0, deployments can use [feature gates](../../get-started/deploy/feature-gates.md) to disable optional features at startup. When a feature is disabled, the Dashboard hides the corresponding menus and pages.
:::
