...
EMQX also supports creating and managing clusters using the Command Line Interface (CLI). For detailed information, see [Create and Manage Cluster](../cluster/create-cluster.md).
