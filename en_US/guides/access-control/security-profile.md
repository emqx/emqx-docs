...
Review the differences between the profiles before overriding this protection. For the compatibility rules and override methods, see [Backup and Restore](../backup-restore.md#security-profile-compatibility).
