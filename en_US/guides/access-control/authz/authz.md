...
- `clientid`: Client ID.
- `client_attrs.*`: Client attributes, for example, `client_attrs.tenant`. For more information about client attributes, see [MQTT Client Attributes](../../../develop/client-attributes/client-attributes.md).
