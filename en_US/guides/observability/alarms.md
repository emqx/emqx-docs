...
You can query and manage alarms through the API. Click **Alarms** on the left navigation menu on the UI to execute this API request. For how to work with EMQX API, see [REST API](../../guides/api.md).
