...
2. Once the installation is complete, create a dedicated [EMQX API key](../api.md#authentication) with the `monitoring` scope. Then modify the Agent configuration file to enable EMQX integration.
