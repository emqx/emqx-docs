...
You can also get the metrics and statistics through the API. Click **Metrics** on the left navigation menu on the UI to execute this API request. For how to work with EMQX API, see [REST API](../../guides/api.md).
