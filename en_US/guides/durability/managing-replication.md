...
Before initializing Durable Storage, ensure that the EMQX data directory on every node uses a local filesystem. [Embedded Durable Storage backends](../../develop/design/durable-storage.md#embedded-backends) do not support network filesystems such as NFS and SMB/CIFS.
