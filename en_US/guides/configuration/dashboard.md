...
- `swagger_support = true`
  ...
  Starting from EMQX 6.3.0, access to API specification content through these endpoints requires authentication. For supported authentication methods and unauthenticated response behavior, see [Access API Specification Endpoints](../api.md#access-api-specification-endpoints).
