...
Download CentOS Package from: [ https://www.emqx.io/downloads/v1/latest/emqttd-centos ](https://www.emqx.io/downloads/v1/latest/emqttd-centos) , and then unzip.zip:
...
Download FreeBSD Package from: [ https://www.emqx.io/downloads/v1/latest/emqttd-freebsd.zip ](https://www.emqx.io/downloads/v1/latest/emqttd-freebsd.zip)
...
Download Mac Package from: [ https://www.emqx.io/downloads/v1/latest/emqttd-macosx.zip ](https://www.emqx.io/downloads/v1/latest/emqttd-macosx.zip)
...
Download Package from: [ https://www.emqx.io/downloads/v1/latest/emqttd-windows.zip ](https://www.emqx.io/downloads/v1/latest/emqttd-windows.zip) .
