...
| [ emq_modules ](https://github.com/emqtt/emq_modules)                 | Extend Modules Plugin         |
...
Renamed the emq_mod_retainer to [ emq_retainer ](https://github.com/emqtt/emq_retainer) project in 2.1-beta release.
...
Released in 2.0-rc.2: [ https://github.com/emqtt/emq_auth_clientid ](https://github.com/emqtt/emq_auth_clientid)
...
Released in 2.0-rc.2: [ https://github.com/emqtt/emq_auth_username ](https://github.com/emqtt/emq_auth_username)
...
| Address          | [ http://localhost\:18083 ](http://localhost:18083) |
| ---------------- | --------------------------------------------------- |
| Default User     | admin                                               |
...
LDAP Auth Plugin: [ https://github.com/emqtt/emq_auth_ldap ](https://github.com/emqtt/emq_auth_ldap)
...
MQTT Authentication/ACL with HTTP API: [ https://github.com/emqtt/emq_auth_http ](https://github.com/emqtt/emq_auth_http)
...
MQTT Authentication, ACL with Redis: [ https://github.com/emqtt/emq_auth_redis ](https://github.com/emqtt/emq_auth_redis)
...
MQTT Authentication/ACL with MongoDB: [ https://github.com/emqtt/emq_auth_mongo ](https://github.com/emqtt/emq_auth_mongo)
...
Merged the [ emq_mod_presence ](https://github.com/emqtt/emq_mod_presence) , [ emq_mod_subscription ](https://github.com/emqtt/emq_mod_subscription) , [ emq_mod_rewrite ](https://github.com/emqtt/emq_mod_rewrite) into one [ emq_modules ](https://github.com/emqtt/emq_modules) project.
...
Released in 2.0-rc.2: [ https://github.com/emqtt/emq_mod_rewrite ](https://github.com/emqtt/emq_mod_rewrite)
...
The plugin loads [ recon ](http://ferd.github.io/recon/) library on a running EMQ broker. Recon libray helps debug and optimize an Erlang application.
...
Template Plugin: [ https://github.com/emqtt/emq_plugin_template ](https://github.com/emqtt/emq_plugin_template)
...
emq*plugin_template_app.erl - register the CLI module to \_EMQ* broker:
...
Create etc/${plugin*name}.conf|config file for the plugin. The \_EMQ* broker supports two type of config syntax:
