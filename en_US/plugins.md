...
| Plugin                                                                      | Description                |
| --------------------------------------------------------------------------- | -------------------------- |
| [ emqttd_plugin_template ](https://github.com/emqtt/emqttd_plugin_template) | Template Plugin            |
| [ emqttd_dashboard ](https://github.com/emqtt/emqttd_dashboard)             | Web Dashboard              |
| [ emqttd_auth_http ](https://github.com/emqtt/emqttd_auth_http)             | HTTP Auth/ACL Plugin       |
| [ emqttd_plugin_mysql ](https://github.com/emqtt/emqttd_plugin_mysql)       | MySQL Auth/ACL Plugin      |
| [ emqttd_plugin_pgsql ](https://github.com/emqtt/emqttd_plugin_pgsql)       | PostgreSQL Auth/ACL Plugin |
| [ emqttd_plugin_redis ](https://github.com/emqtt/emqttd_plugin_redis)       | Redis Auth/ACL Plugin      |
| [ emqttd_plugin_mongo ](https://github.com/emqtt/emqttd_plugin_mongo)       | MongoDB Auth/ACL Plugin    |
| [ emqttd_stomp ](https://github.com/emqtt/emqttd_stomp)                     | STOMP Protocol Plugin      |
| [ emqttd_sockjs ](https://github.com/emqtt/emqttd_sockjs)                   | STOMP over SockJS Plugin   |
...
MQTT Authentication/ACL with HTTP API: [ https://github.com/emqtt/emqttd_auth_http ](https://github.com/emqtt/emqttd_auth_http)
...
MQTT Authentication, ACL with Redis: [ https://github.com/emqtt/emqttd_plugin_redis ](https://github.com/emqtt/emqttd_plugin_redis)
...
MQTT Authentication, ACL with MongoDB: [ https://github.com/emqtt/emqttd_plugin_mongo ](https://github.com/emqtt/emqttd_plugin_mongo)
...
The plugin loads [ recon ](http://ferd.github.io/recon/) library on a running emqttd broker. Recon libray helps debug and optimize an Erlang application.
...
Template Plugin: [ https://github.com/emqtt/emqttd_plugin_template ](https://github.com/emqtt/emqttd_plugin_template)
