...
- A new telemetry function is added to collect information about the usage of EMQX Broker to help us improve the product. This function is enabled by default and supports manual disabled. Visit [Telemetry](../telemetry/telemetry.md) for more telemetry-related information.
