...
- HTTP authentication
  ...
  - In EMQX 5.x, HTTP authentication has been redesigned to make use of the HTTP body. Refer to [HTTP service authentication](../guides/access-control/authn/http.md#http-request-and-response) for more detailed information.
...
- HTTP 
  ...
  - In EMQX 5.0, HTTP authorization has been redesigned to make use of the HTTP body. Refer to [HTTP Request and Response](../guides/access-control/authz/http.md#http-request-and-response) for more information.
...
If you want to enable push-gateway, refer to [Integrate with Prometheus](../guides/observability/prometheus.md).
