...
8. Configure the Sink information.
   - **Event Hub Name**: Enter the name of the Event Hub to be used. Starting from EMQX v5.7.2, this field also supports dynamic topics configuration. Refer to [Configure Kafka Dynamic Topics](./data-integration-kafka.md#configure-kafka-dynamic-topics) for details. 
