...
| [ emq_auth_username ](https://github.com/emqtt/emq_auth_username) | Username Auth Plugin    |
...
| [ emq_auth_pgsql ](https://github.com/emqtt/emq_auth_pgsql)       | Postgre Auth/ACL Plugin |
...
Enable [ emq_auth_username ](https://github.com/emqtt/emq_auth_username) plugin:
...
Enable [ emq_auth_clientid ](https://github.com/emqtt/emq_auth_clientid) plugin:
...
ACL by HTTP API: [ https://github.com/emqtt/emq_auth_http ](https://github.com/emqtt/emq_auth_http)
...
MQTT Client Libraries: [ https://github.com/mqtt/mqtt.github.io/wiki/libraries ](https://github.com/mqtt/mqtt.github.io/wiki/libraries)
...
MQTT V3.1.1 Protocol Specification: [ http://docs.oasis-open.org/mqtt/mqtt/v3.1.1/mqtt-v3.1.1.html ](http://docs.oasis-open.org/mqtt/mqtt/v3.1.1/mqtt-v3.1.1.html)
...
HTTP API: POST [ http://host:8080/mqtt/publish ](http://host:8080/mqtt/publish)
